...
func (in *CertDXClusterIssuerList) DeepCopyInto(out *CertDXClusterIssuerList) {
	*out = *in
	...
	if in.Items != nil {
		...
		*out = make([]CertDXClusterIssuer, len(*in))
		for i := range *in {
...
func (in *CertDXClusterIssuerList) DeepCopy() *CertDXClusterIssuerList {
	if in == nil {
		return nil
	}
	out := new(CertDXClusterIssuerList)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CertDXClusterIssuerSpec) DeepCopy() *CertDXClusterIssuerSpec {
	if in == nil {
		return nil
	}
	out := new(CertDXClusterIssuerSpec)
	in.DeepCopyInto(out)
	return out
}
